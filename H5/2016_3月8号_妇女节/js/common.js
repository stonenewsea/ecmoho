...
var pop_up_note_mode = true;
        ...
        function popup_note() {
            ...
            note.style.cssText = "visibility:visible;position:absolute;background-image:url('img/musicalNotes.png');width:15px;height:25px";
        ...
        function playbksound() {
            ...
            sound_div.style.cssText = "position:fixed;right:20px;top:20px;z-index:998;visibility:visible;";
            sound_div.onclick = switchsound;
            if (document.body.offsetWidth > 400) {
                bg_htm = "<img id='sound_image' class='' src='img/units-icons.png'>";
                box_htm = "<div id='note_box' style='height:100px;width:44px;position:absolute;left:-20px;top:-80px'></div>";
            }
            else {
                bg_htm = "<img id='sound_image' width='30px' class='' src='img/units-icons.png'>";
